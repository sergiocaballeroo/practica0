...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, 0.5f, glm::vec3(0.0f, 2.0f, 3.0f));
		...
		//Dibujar 2 cubos extra -> crear dos cubos a la derecha y a la izquierda con diferente traslacion, escala, rotacion, etc 
